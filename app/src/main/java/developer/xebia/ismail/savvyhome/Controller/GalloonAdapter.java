...
public class GalloonAdapter extends RecyclerView.Adapter<GalloonAdapter.ViewHolder> {

    private List<GalloonItem> items;
    private int itemLayout;
    Context mContext;

    public GalloonAdapter(List<GalloonItem> items, Context mContext, int itemLayout) {
        this.items = items;
    ...
    @Override public void onBindViewHolder(final ViewHolder holder, int position) {
        final GalloonItem item = items.get(position);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            nama = (FontAppCompatTextView) v.findViewById(R.id.value_gallon);
        }
    }
}
