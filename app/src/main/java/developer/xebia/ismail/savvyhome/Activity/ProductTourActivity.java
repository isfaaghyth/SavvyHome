...
public class ProductTourActivity extends AppCompatActivity {
    ...
    private void buildCircles(){
        ...
        int padding = (int) (1 * scale + 0.1f);

        for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
            ImageView circle = new ImageView(this);
            circle.setImageResource(R.drawable.ic_indic);
    ...
    private void setIndicator(int index){
        if(index < NUM_PAGES){
            for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
                ...
                if(i == index){
                    circle.setColorFilter(getResources().getColor(R.color.select));
                }else {
    ...
    private void endTutorial(){
        if(prefs.getBoolean("firstrun", true)) {
            ...
            Intent i = new Intent(ProductTourActivity.this, MainActivity.class);
            startActivity(i);
            finish();
        } else {
            finish();
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = ProductTourFragment.newInstance(R.layout.intro_first);
                    break;
                case 1:
                    tp = ProductTourFragment.newInstance(R.layout.intro_second);
                    break;
                case 2:
                    tp = ProductTourFragment.newInstance(R.layout.activity_main);
                    break;
            }
    ...
    public class CrossfadePageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            View welcomeImage01 = page.findViewById(R.id.a);
            View welcomeImage02 = page.findViewById(R.id.b);
            View welcomeImage03 = page.findViewById(R.id.c);
            ...
            if(position <= -1.0f || position >= 1.0f) {
                ...
                if (text_content != null) {
                    ...
                    ViewHelper.setTranslationX(text_head,(float)(pageWidth/1.5 * position));
                }
